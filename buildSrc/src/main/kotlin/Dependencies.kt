object Dependencies {
  ...
  val sqldelightGradlePlugin = "app.cash.sqldelight:gradle-plugin:2.0.0"
  val sqldelightJdbcDriver = "app.cash.sqldelight:jdbc-driver:2.0.0"
  val sqldelightMysqlDialect = "app.cash.sqldelight:mysql-dialect:2.0.0"
